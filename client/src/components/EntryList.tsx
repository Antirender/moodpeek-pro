...
export default function EntryList({ onEdit }: EntryListProps) {
  ...
  return (
    <div>
      ...
      {entries.length === 0 ? (
        <div className="entries-empty-panel">
          <h4>No entries yet</h4>
          <p className="muted">Your first mood will show up here after you save it.</p>
          <p className="muted">Use the New Entry form on the left to start your log, then come back to see it listed.</p>
        </div>
      ) : (
